...
Choices we had to make regarding the design:
...
- This project helped us understand how Lex works and how each token is recognized.  
- we suggest adding more test input examples in the next phase to help us practice more cases.
